            ...
            <aside>
                ...
                <!-- sidebar menu start-->
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub">
                            <a  href="gererProfesseur.php">
                            <i class="fa fa-dashboard"></i>
                            <span>Gestion professeur</span>                                
                            </a>
                        </li>
                        <li class="sub">
                            <a  class="active" href="gererEtudiant.php">
                            <i class="fa fa-dashboard"></i>
                    ...
                    <div class="row">
                        ...
                        ?>      
                                    <tr class="lien">
                                        ...
                                        <td> <?= $user['userRole'] ?> </td>
                                        <td> <?= $user['classe'] ?> </td>
                                        <td> <a class="btn btn-theme" href="editEtudiant.php?id=<?=$user['id']?>"> Modifier </a> 
                                        <a class="btn btn-theme04" href="deleteEtudiant.php?id=<?$user['id']?>">Supprimer </a> </td>
                                </tr>
                            <?php
                                }
                            } ?>
                            </table>
                             <a class="btn" href="addEtudiant.php"> Ajouter un etudiant </a>
                        </div>
                    </div>
                </section>
            </section>
