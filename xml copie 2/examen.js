...
function creerQuestion(divExo, numExo, nbQ)
{
    ...
    divExo.appendChild(divNumQ);
    divExo.appendChild(divNbPointQ);
...
function addOption(div, numExo, nbQ, nb)
{
    ...
    labelOption.setAttribute("for", "optionQ" + numExo + nbQ);
    ...
    choix.setAttribute("name", "optionQ" + numExo + nbQ);
    choix.setAttribute("id", "optionQ" + numExo + nbQ);
